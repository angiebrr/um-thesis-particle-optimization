...
\newcommand{\mytitle}{ChilliSource Game Engine Particle Study }
\newcommand{\mytitlecaps}{CHILLISOURCE GAME ENGINE PARTICLE STUDY }

\newcommand{\mysubtitle}{}     %you may or may not even want a subtitle
...
\newcommand{\myprevdegdatetwo}{2014}
...
\newcommand*\vtick{\textsc{\char13}} %A single vertical apostrophe
