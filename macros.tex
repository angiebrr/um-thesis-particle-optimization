...
\newcommand{\mytitle}{ChilliWorks Game Engine Particle Optimization }
\newcommand{\mytitlecaps}{CHILLIWORKS GAME ENGINE PARTICLE OPTIMIZATION }
...
%approval and committee members----------------------------
	...
	\newcommand{\committeemembertwodept}{Amazing Sciences}
